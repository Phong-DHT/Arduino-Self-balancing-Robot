...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.clc = QtWidgets.QPushButton(self.groupBox)
        self.clc.setGeometry(QtCore.QRect(880, 30, 171, 31))
        self.clc.setObjectName("clc")
        self.widget = QtWidgets.QWidget(self.centralwidget)
        self.widget.setGeometry(QtCore.QRect(330, 0, 751, 611))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.clc.setText(_translate("MainWindow", "Clear Output"))
